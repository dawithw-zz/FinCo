...
public class AddPersonalCCAccount extends javax.swing.JDialog
{
    private CCWindow parentframe;
	...
	public AddPersonalCCAccount(CCWindow parent)
	{
		super(parent);
		parentframe=parent;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
       ...
       parentframe.param.setAccountNumber(JTextField_CCNR.getText());
       parentframe.param.setExpiryDate(LocalDate.parse(JTextField_ExpDate.getText(), DateTimeFormatter.ofPattern("MM/dd/yyyy")));
       if (JRadioButton_Gold.isSelected()) {
           	parentframe.param.setAccountType("Gold");
           	CCard.createPersonalGoldAccount(parentframe.param);
       } else if (JRadioButton_Silver.isSelected()) {
    	   	parentframe.param.setAccountType("Silver");
    	   	CCard.createPersonalSilverAccount(parentframe.param);
       } else {
    	   	parentframe.param.setAccountType("Bronze");
       		CCard.createPersonalBronzeAccount(parentframe.param);
       }
